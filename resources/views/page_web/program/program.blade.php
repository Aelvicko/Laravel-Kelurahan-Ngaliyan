		...
		<div class="container my-5 py-md-5">
			<section class="--section-page"  style="margin-bottom: -100px; margin-top:-50px; margin-left: -12px; margin-right: -12px">
				<div class="row d-flex justify-content-center align-items-center">
					...
					<a href="#a-more" style="margin-bottom: 10px; margin-top:10px;" 
					   class="read-more text-decoration-none text-black border w-auto py-2 px-5">Layanan</a>
				</div>
				</section>
		</div>
				...
				<div class="row d-flex justify-content-between align-items-center">
					...
					<div class="col-lg-6 mt-4 mt-lg-0 ps-4 mb-5">
						<div class="row">
							...
							<p class="headline-paragraph" style="color: white; font-size: 1rem">Kelurahan Ngaliyan
...
<div class="row row-cols-1 row-cols-md-3 g-4" style="max-width: 100%; margin-left:5%; margin-right:5%; margin-bottom:5%;">
 ...
 <!-------------------HARUSNYA DISINI ADA TAMPILAN KELEMBAGAAN & PEMBERDAYAAN ------------------------>
 <!-------------------TPI SUDAH DI HAPUS VICKO ------------------------>
