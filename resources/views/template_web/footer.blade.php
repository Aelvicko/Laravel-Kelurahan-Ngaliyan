...
====================================================================== */
    ...
    .social-network a.icoRss:hover i.sc,
    .social-network a.icoFacebook:hover i.sc,
    .social-network a.icoTwitter:hover i.sc,
    .social-network a.icoGoogle:hover i.sc,
    .social-network a.icoInstagram:hover i.sc,
    .social-network a.icoVimeo:hover i.sc,
    .social-network a.icoLinkedin:hover i.sc {
        color: #fff;
    }
                ...
                <div class="col-md-12 d-flex align-items-center">
                    ...
                    <div class="col-md-2 text-center">
                        <img src="images/logo/logosemarang.png"
                            style="width: 100%; max-width: 90px; max-height: 85px; margin-top: 5px">
                    </div>
                    ...
                    <div class="col-md-6" style="margin-left: -80px">
                        ...
                        <p style="font-size:0.80em; margin-top: -10px;">
                            ...
                            <a href="mailto:officialngaliyan@gmail.com"
                                style="color: #FFCC00; text-decoration: none;">officialngaliyan@gmail.com</a>
                        </p>
                    </div>
                </div>
