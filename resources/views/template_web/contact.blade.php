{{-- YANG DIBBERI KOMEN PATUT DI SOROTI --}}
        ...
        <div class="u-layout-row">
              ...
              <div class="u-form u-form-1">
                <form action="{{ route('kontak.store') }}" method="POST"
                  ...
                  <div class=" u-form-group u-form-message">
                    ...
                    <textarea placeholder="Tulis pesan" rows="4" cols="50" id="message-319a" name="message"
                      class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-white u-input u-input-rectangle u-body-alt-color"
                  ...
                  <div class="u-align-left u-form-group u-form-submit">
                    <a href="#"
                      class="u-active-white u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-white u-palette-3-base u-radius-50 u-text-active-palette-3-base u-text-body-alt-color u-text-hover-palette-3-base u-btn-2">Submit</a>
          ...
          <div
            ...
            <div class="u-container-layout u-container-layout-6">
              <h2 class="u-align-left u-text u-text-body-alt-color u-text-default u-text-9">Kantor Kelurahan Ngaliyan
              </h2>
              <h6 class="u-align-left u-custom-font u-text u-text-body-alt-color u-text-font u-text-10">
                Selamat Datang di Website Resmi Kel. Ngaliyan Kec. Ngaliyan Jl. Raya Ngaliyan, Kota Semarang, Jawa
                Tengah
              </h6>
              <p class="u-align-left u-text u-text-body-alt-color u-text-11">
                Kontak Kami melalui phone <i>(024) 7600874</i> atau email <a href="mailto:officialngaliyan@gmail.com"
                  class="u-active-none u-border-1 u-border-active-black u-border-hover-black u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-3-base u-btn-1">
              ...
              <div class="u-social-icons u-spacing-20 u-social-icons-1">
                ...
                <a class="u-social-url" target="_blank" href="https://www.linkedin.com/">
                  <span class="u-icon u-icon-circle u-social-icon u-social-linkedin u-text-palette-3-base u-icon-8">
                    <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
